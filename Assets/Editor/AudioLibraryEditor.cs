    ...
    public override void OnInspectorGUI() {
        ...
        for (int currentOctave = 0; currentOctave < numberOfOctaves; currentOctave++) {
            ...
            if (expandOctaves[currentOctave]) {
                ...
                audioLibrary.notes[offset + 0] =  DrawNoteGUI(audioLibrary.notes[offset + 0], "A");
                audioLibrary.notes[offset + 1] =  DrawNoteGUI(audioLibrary.notes[offset + 1], "A# / Bb");
                audioLibrary.notes[offset + 2] =  DrawNoteGUI(audioLibrary.notes[offset + 2], "B");
                audioLibrary.notes[offset + 3] =  DrawNoteGUI(audioLibrary.notes[offset + 3], "C");
                audioLibrary.notes[offset + 4] =  DrawNoteGUI(audioLibrary.notes[offset + 4], "C# / Bb");
                audioLibrary.notes[offset + 5] =  DrawNoteGUI(audioLibrary.notes[offset + 5], "D");
                audioLibrary.notes[offset + 6] =  DrawNoteGUI(audioLibrary.notes[offset + 6], "D# / Eb");
                audioLibrary.notes[offset + 7] =  DrawNoteGUI(audioLibrary.notes[offset + 7], "E");
                audioLibrary.notes[offset + 8] =  DrawNoteGUI(audioLibrary.notes[offset + 8], "F");
                audioLibrary.notes[offset + 9] =  DrawNoteGUI(audioLibrary.notes[offset + 9], "F# / Gb");
                audioLibrary.notes[offset + 10] = DrawNoteGUI(audioLibrary.notes[offset + 10], "G");
                audioLibrary.notes[offset + 11] = DrawNoteGUI(audioLibrary.notes[offset + 11], "G# / Ab");
